...
const Module_1_2_Qual = () => {
  const tableDataModuleOne = [
    {
      topic: "Climate Change",
      subTopic: "Environment Policy & Certifications",
      slNo: "1.1",
    ...
    },
    {
      ...
      guidance:
        "This information will be useful for requesting members to link your data with water stress maps, and the types of risk exposure in those water stressed areas.",
      response: "SDP184_31",
    },
    {
      topic: "Company Information",
    ...
    {
      topic: "Business Activities of the organization",
      subTopic: "Business Activities of the organization",
      slNo: "1.10",
      question:
  ...
  const tableDataModuleTwo = [
    {
      topic: "Climate Change",
      subTopic: "Process for identifying of Risk and Opportunities",
      slNo: "2.1",
      question:
        "How does your organization define short-, medium-, and long-term time horizons in relation to the identification, assessment, and management of your environmental dependencies, impacts, risks, and opportunities?",
      guidance:
        "Understanding organizations’ definitions of time horizons allows data users to contextualize the different timescales at which organizations consider environmental issues in the identification, assessment, and management of dependencies, impacts, risks, and opportunities, and how this informs their business strategy and financial planning.",
      response: "SDP122_19",
    },
    {
      topic: "Climate Change",
    ...
    },
    {
      ...
      guidance:
        "Assessing biodiversity impacts before the development of a mining project as part of an Environmental Impact Assessment (EIA) improves decision making and resource allocation, as well as helping to avoid costs associated with unforeseen issues. Indicating how your projects have gone through such assessment before the project development stage provides evidence to data users that biodiversity impacts have been considered before implementation of the project.",
      response: "SDP122_22",
      markedRed: true,
    },
    {
    ...
    },
    {
      ...
      guidance:
        "Indicators and thresholds employed to define which effects on the organization are considered substantive can differ among disclosers depending on their sector, value chain, or geography. Therefore, outlining clear definitions on how organizations determine potential effects as substantive provides clarity as to what the discloser deems to be a substantive effect on their organization. This question increases transparency and improves clarity as to what the discloser deems to be a substantive effect on their organization.",
      response: "SDP123_54",
    },
    {
      topic: "Climate Change",
...
export default Module_1_2_Qual;
